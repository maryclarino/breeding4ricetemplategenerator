<?php
//-----------------------------PAGE FOR FOURTH LAYOUT: TRAY LABEL---------------------------//
	use yii\helpers\Html;
	use yii\helpers\Url;
	use yii\widgets\ActiveForm;
	$this->title = 'Tray Label';
...
<!------------------SIDE BAR--------------->
	...
	<?php $form = ActiveForm::begin([
			'id' => 'select-form',
			'method' => 'get',
			'action' => Url::to(['users/user_fourthinput']),
			]); 
	?>
		<?= Html::img('@web/img/labels/traylabels2.png', ['id' => 'fieldlabel', 'alt'=>'some','width'=>300]);?>
		<input id = "seventh_text" name = "input" type = "text" placeholder = "Enter Text Here" style = "font-size:50px;font-weight:bold;height:70px">
