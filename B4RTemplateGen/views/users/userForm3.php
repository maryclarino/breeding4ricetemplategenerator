<?php
//-----------------------------PAGE FOR THIRD LAYOUT: SHELF LABEL---------------------------//
	use yii\helpers\Html;
	use yii\helpers\Url;
	use yii\widgets\ActiveForm;
	$this->title = 'Shelf Label';
?>
<?php 
...
<!------------------SIDE BAR--------------->
	...
	<?php $form = ActiveForm::begin([
			'id' => 'select-form',
			'method' => 'get',
			'action' => Url::to(['users/user_thirdinput']),
			]); 
	?>
	<?= Html::img('@web/img/labels/shelflabels2.png', ['id' => 'shelflabel', 'alt'=>'some', 'width'=>300]);?> 
	<input id = "sixth_text" name = "input" type = "text" placeholder = "Enter Text Here" style = "text-align:center;font-size:40px;font-weight:bold;height:90px;">
	</div>
